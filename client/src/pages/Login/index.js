	...
	return (
		<>
			...
			>
				...
				<LoginInput type="text" name="id" placeholder="아이디" value={id} onChange={onChange} />
				<LoginInput type="text" name="password" placeholder="비밀번호" value={password} onChange={onChange} />
			...
			<Footer>
				<Links mobile={isMobile ? true : false}>
					<Link><a href="https://everytime.kr/page/serviceagreement">이용약관</a></Link>
					<Link bold={true}><a href="https://everytime.kr/page/privacy">개인정보처리방침</a></Link>
					<Link><a href="https://everytime.kr/page/faq">문의하기</a></Link>
					<Link bold={true}><a href="https://everytime.kr/">© 에브리타임</a></Link>
...
const Logo = styled.h1`
	...
	background: transparent url(${props => props.mobile ? mlogo : logo}) no-repeat;
